const getCostOfEquityCapital = () => {
    let cost_of_equity_capital_ele = document.getElementById("cost_of_equity_capital_input");
    let risk_free_rate_ele = document.getElementById("risk_free_rate_input");
    let market_risk_premium_ele = document.getElementById("market_risk_premium_input");
    ...
    cost_of_equity_capital_ele.value = (risk_free_rate + company_beta*market_risk_premium).toFixed(2);
}
...
const getCostOfDebt = () => {
    let company_outstanding_bonds_ele = document.getElementById("company_outstanding_bonds_input");
    let marginal_tax_rate_ele = document.getElementById("marginal_tax_rate_input");
    let cost_of_debt_ele = document.getElementById("cost_of_debt_input");

    let company_outstanding_bonds = parseFloat(company_outstanding_bonds_ele.value);
    let marginal_tax_rate = parseFloat(marginal_tax_rate_ele.value);

    console.log(company_outstanding_bonds, marginal_tax_rate);

    cost_of_debt_ele.value = (company_outstanding_bonds * (1 - marginal_tax_rate/100)).toFixed(2);
...
const getWACC = () => {
    ...
    wacc_ele.value = (equity_weight * cost_of_equity_capital_ele.value + debt_weight * cost_of_debt_ele.value).toFixed(2);
}
...
const getFutureValue = () =>{
    ...
    future_value_input.value = (present_value * ((1+(rate/100))**time)).toFixed(2);
...
const getPresentValue = () =>{
    ...
    present_value_pv_input.value = (future_value_pv * ((1+ (rate_pv/100))**(-time_pv))).toFixed(2);
}
...
const getPresentValuePerpetuity = () =>{
    let pmt_pv_perpetuity_ele = document.getElementById("pmt_pv_perpetuity_input");
    let rate_pv_perpetuity_ele = document.getElementById("rate_pv_perpetuity_input");
    ...
    pv_perpetuity_input.value = (pmt_pv_perpetuity*(1/(rate_pv_perpetuity/100))).toFixed(2);
}
...
const getPresentValueGrowingPerpetuity = () =>{
    let pmt_pv_growing_perpetuity_ele = document.getElementById("pmt_pv_growing_perpetuity_input");
    let rate_pv_growing_perpetuity_ele = document.getElementById("rate_pv_growing_perpetuity_input");
    let growth_pv_growing_perpetuity_ele = document.getElementById("growth_pv_growing_perpetuity_input");

    let pmt_pv_growing_perpetuity = parseFloat(pmt_pv_growing_perpetuity_ele.value);
    let rate_pv_growing_perpetuity = parseFloat(rate_pv_growing_perpetuity_ele.value);
    let growth_pv_growing_perpetuity = parseFloat(growth_pv_growing_perpetuity_ele.value);
    ...
    (
        ...
        (1/
            (
                (rate_pv_growing_perpetuity/100) -
                (growth_pv_growing_perpetuity/100)
            )
        )
    ).toFixed(2);
}
...
const resetPresentValueGrowingPerpetuity = () =>{
    ...
    let rate_pv_growing_perpetuity_ele = document.getElementById("rate_pv_growing_perpetuity_input");
    let growth_pv_growing_perpetuity_ele = document.getElementById("growth_pv_growing_perpetuity_input");
    let pv_growing_perpetuity_ele = document.getElementById("pv_growing_perpetuity_input");
...
const getPresentValueRegularAnuuity = () => {
    let pmt_pv_regular_annuity_ele = document.getElementById("pmt_pv_regular_annuity_input");
    let rate_pv_regular_annuity_ele = document.getElementById("rate_pv_regular_annuity_input");
    let time_pv_regular_annuity_ele = document.getElementById("time_pv_regular_annuity_input");
    ...
    (
        ...
        (
            (1 - 
                ((1+(rate_pv_regular_annuity/100)) ** (-time_pv_regular_annuity))
            )/
...
const resetPresentValueRegularAnnuity =() => {
    ...
    let rate_pv_regular_annuity_ele = document.getElementById("rate_pv_regular_annuity_input");
    let time_pv_regular_annuity_ele = document.getElementById("time_pv_regular_annuity_input");
    let pv_regular_annuity_ele = document.getElementById("pv_regular_annuity_input");
...
const getFutureValueRegularAnuuity = () =>{
    let pmt_fv_regular_annuity_ele = document.getElementById("pmt_fv_regular_annuity_input");
    let rate_fv_regular_annuity_ele = document.getElementById("rate_fv_regular_annuity_input");
    let time_fv_regular_annuity_ele = document.getElementById("time_fv_regular_annuity_input");
...
const resetFutureValueRegularAnnuity = ()=>{
    ...
    let rate_fv_regular_annuity_ele = document.getElementById("rate_fv_regular_annuity_input");
    let time_fv_regular_annuity_ele = document.getElementById("time_fv_regular_annuity_input");
    let fv_regular_annuity_ele = document.getElementById("fv_regular_annuity_input");
...
const getPresentValueAnuuityDue = () => {
    let pmt_pv_annuity_due_ele = document.getElementById("pmt_pv_annuity_due_input");
    let rate_pv_annuity_due_ele = document.getElementById("rate_pv_annuity_due_input");
    let time_pv_annuity_due_ele = document.getElementById("time_pv_annuity_due_input");
...
const getFutureValueAnuuityDue = () => {
    let pmt_fv_annuity_due_ele = document.getElementById("pmt_fv_annuity_due_input");
    let rate_fv_annuity_due_ele = document.getElementById("rate_fv_annuity_due_input");
    let time_fv_annuity_due_ele = document.getElementById("time_fv_annuity_due_input");
